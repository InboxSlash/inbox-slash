...
export async function ApiKeysSection() {
  ...
  return (
    <FormSection>
      <FormSectionLeft
        title="API keys"
        description="Create an API key to access the Inbox Slash API. Do not share your API key with others, or expose it in the browser or other client-side code."
      />
